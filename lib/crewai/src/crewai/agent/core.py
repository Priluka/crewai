...
class Agent(BaseAgent):
    ...
    def create_agent_executor(
        ...
        if existing_token_handler:
            ...
            if not existing_token_handler._redis_client and all(
                    hasattr(self, attr) for attr in ['_redis_client', '_session_id', '_model_id']):
            ...
            # Pass agent=self for lazy Redis attribute resolution
          token_handler = TokenCalcHandler(self._token_process, agent=self)
        ...
        if self.agent_executor is not None:
            ...
            self.agent_executor = self.executor_class(
                ...
                callbacks=[TokenCalcHandler(self._token_process, agent=self)],
