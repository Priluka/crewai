...
class LLM(BaseLLM):
    ...
    def __new__(cls, model: str, is_litellm: bool = False, **kwargs: Any) -> LLM:
        ...
        # Check is_litellm BEFORE calling _get_native_provider to avoid importing native SDKs
        native_class = cls._get_native_provider(provider) if use_native and not is_litellm else None
